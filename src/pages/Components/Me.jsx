    ...
    <div className={gStyles.grid}>
        <div className={styles.titleBlock}>
            <div className={styles.frontTitle}>
                <ScrollAnimation className={styles.title} animateIn="fadeInRight" animateOut="fadeOutRight">
                    Kovács Gergő
                </ScrollAnimation>
                <ScrollAnimation className={styles.logos} animateIn="fadeInLeft" animateOut="fadeOutLeft" offset="180">
            ...
            <ScrollAnimation  animateIn="fadeInUp" animateOut="fadeOutDown"  className={styles.person}>
                <img src={image} alt=""/>
            </ScrollAnimation>
        </div>
        <div className={styles.description}>
            ...
            <ScrollAnimation animateIn="fadeInLeft" animateOut="fadeOutLeft" offset="180"> 
